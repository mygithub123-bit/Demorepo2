...
public class AccountValidationPage {
	...
	public void getTextFromElements() throws InterruptedException {
		...
		for (int i = 0; i < a.size(); i++) {
			...
			if (a.get(i).getText().equals("welcome" + "s")) { // if u want to click on the specific mail then here u can
																// pass
				// it
				...
				driver.findElement(By.xpath("//a[contains(text(),'Please click here to validate your account.')]"))
						.click();
